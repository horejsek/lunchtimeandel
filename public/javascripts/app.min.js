...
goog.events.wrapListener_=function(a){return goog.isFunction(a)?a:a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)})};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});var lta={};lta.Search=function(){function a(a){var c;c=this;this.searchbox_=goog.dom.getElement(a);goog.events.listen(this.searchbox_,goog.events.EventType.INPUT,function(){return c.search()})}a.prototype.searchbox_=null;a.prototype.search=function(){var a,c,d,e,f,g,h;a=this.searchbox_.value.toLowerCase();g=goog.dom.getElementsByClass("meal");h=[];e=0;for(f=g.length;e<f;e++)c=g[e],d=!a||-1<c.innerHTML.toLowerCase().indexOf(a),h.push(goog.dom.classes.enable(c,"hidemeal",!d));return h};return a}();
