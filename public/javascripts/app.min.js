...
lta.Search=function(){function a(a){var c;c=this;this.searchbox_=goog.dom.getElement(a);goog.events.listen(this.searchbox_,goog.events.EventType.INPUT,function(){return c.search()})}a.prototype.searchbox_=null;a.prototype.search=function(){var a,c,d,e,f,g,h;a=this.searchbox_.value.toLowerCase();this.removeHighlight_();g=goog.dom.getElementsByClass("meal");h=[];e=0;for(f=g.length;e<f;e++)c=g[e],(d=!a||-1<c.innerHTML.toLowerCase().indexOf(a))&&a&&this.highlight_(c),h.push(goog.dom.classes.enable(c,"hidemeal",
!d));return h};a.prototype.highlight_=function(a){var c,d;c=a.innerHTML.toLowerCase();d=RegExp("(>[^<.]*)("+this.searchbox_.value.toLowerCase()+")([^<.]*)","g");return a.innerHTML=c.replace(d,'$1<span class="highlight label label-warning">$2</span>$3')};a.prototype.removeHighlight_=function(){var a,c,d,e,f,g;f=goog.dom.getElementsByClass("highlight");g=[];d=0;for(e=f.length;d<e;d++)a=f[d],c=goog.dom.createTextNode(goog.dom.getTextContent(a)),g.push(goog.dom.replaceNode(c,a));return g};return a}();
